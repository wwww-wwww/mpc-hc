...
#define WAVE_FORMAT_OPUS_2    mmioFOURCC('O','P','U','S')
DEFINE_GUID(MEDIASUBTYPE_OPUS,
            WAVE_FORMAT_OPUS_2, 0x000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71);
...
#define FOURCC_RBA_at mmioFOURCC('R','B','A','@')
#define FOURCC_at_RBA mmioFOURCC('@','R','B','A')
...
DEFINE_GUID_FOURCC(RBA_at)
DEFINE_GUID_FOURCC(at_RBA)
