...
void CPPageAdvanced::InitSettings()
{
    ...
    addCStringItem(YDL_COMMAND_LINE, IDS_RS_YDL_COMMAND_LINE, StrRes(IDS_PPAGEADVANCED_YDL_COMMAND_LINE), s.sYDLCommandLine, StrRes(IDS_PPAGEADVANCED_YDL_COMMAND_LINE));
