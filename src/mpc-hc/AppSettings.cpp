...
static constexpr wmcmd_base default_wmcmds[] = {
    ...
    { ID_SUB_POS_DOWN,                      0, FVIRTKEY | FNOINVERT,                    IDS_SUB_POS_DOWN },
    { ID_SUB_POS_UP,                        0, FVIRTKEY | FNOINVERT,                    IDS_SUB_POS_UP },
    { ID_SUB_FONT_SIZE_DEC,                 0, FVIRTKEY | FNOINVERT,                    IDS_SUB_FONT_SIZE_DEC },
    { ID_SUB_FONT_SIZE_INC,                 0, FVIRTKEY | FNOINVERT,                    IDS_SUB_FONT_SIZE_INC },
