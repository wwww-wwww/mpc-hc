...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --x86asmexe=yasm --extra-ldflags=' -LIBPATH:../../../thirdparty/64/lib -LIBPATH:../../../../../../../bin/lib/Debug_x64 -NODEFAULTLIB:libcmt' --extra-cflags='-D_WIN32_WINNT=0x0600 -DWINVER=0x0600 -Zo -GS- -I../../../thirdparty/64/include -I../../../../../../thirdparty/zlib -MDd' --pkg-config-flags='--static --define-variable=prefix=../../../thirdparty/64' --enable-gpl --enable-version3 --enable-w32threads --enable-static --disable-shared --disable-everything --disable-mediafoundation --disable-schannel --disable-dxva2 --disable-d3d11va --disable-programs --disable-doc --disable-avformat --disable-avdevice --disable-devices --disable-postproc --disable-swscale --enable-filter='abuffer,abuffersink,atempo,aresample' --arch=x86_64 --enable-debug"
...
#define HAVE_DXVA_PICPARAMS_AV1 0
#define HAVE_DXVA_PICPARAMS_HEVC 1
#define HAVE_DXVA_PICPARAMS_VP9 0
